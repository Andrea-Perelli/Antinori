...
namespace Antinori.Controllers {
    ...
    public class MailController : ApplicationController {
        ...
        public void SendEmail(string subject, string msg, string to) {
            ...
            try {
                Log_Insert("", "AspNetUsers", "SEND EMAIL", true, "Inizio invio email a: " + to, subject, "", "", "");
                string userId = "";
                if(
                    ...
                    userId = this.Dc.AspNetUsers_Get_ByName(System.Web.HttpContext.Current.User.Identity.Name).Id;
                }
                ...
                Log_Insert(userId, "AspNetUsers", "SEND EMAIL", true, "2Inizio invio email a: " + to, from, subject, msg, "");
                ...
                if(ex.InnerException != null) {
                    ...
                    Log_Insert("", "AspNetUsers", "SEND EMAIL", false, msgEx, "", "", "", "");
